...
public class ReadRewardData : MonoBehaviour
{
    ...
    public void Load(string jsonString)
    {
        ...
        // BrainRewardData data = JsonUtility.FromJson<BrainRewardData>(jsonString);
        //     print(data.GetType());
        // foreach (RewardData item in data.rewardData)
        // {
        //     print(item.currentMeanReward);
        //     print(item.brainName);
        //     print(item.currentStdDeviation);
