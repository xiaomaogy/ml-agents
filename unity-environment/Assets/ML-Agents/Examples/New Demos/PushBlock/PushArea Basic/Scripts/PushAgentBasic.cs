//Put this script on your cube agent
...
public class PushAgentBasic : Agent
{
	...
	void Awake()
	{
		goalStartingPos = goal.transform.position;
    ...
    public Vector3 GetRandomGoalPos()
    {
        ...
        randomGoalPos = ground.transform.position + new Vector3(randomPosX, goalStartingPos.y - ground.transform.position.y, randomPosZ );
